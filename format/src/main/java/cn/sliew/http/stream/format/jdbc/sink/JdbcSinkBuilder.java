...
public class JdbcSinkBuilder {
    ...
    private void setParameter(PreparedStatement statement, int parameterIndex, FieldVector fieldVector) throws SQLException {
        if (fieldVector instanceof TinyIntVector) {
            ...
            statement.setTimestamp(parameterIndex, Timestamp.valueOf(timeStampMilliVector.getObject(0)));
            ...
            statement.setTimestamp(parameterIndex, Timestamp.valueOf(timeStampMicroVector.getObject(0)));
            ...
            statement.setTimestamp(parameterIndex, Timestamp.valueOf(timeStampNanoVector.getObject(0)));
        } else if (fieldVector instanceof TimeMicroVector) {
            TimeMicroVector timeMicroVector = (TimeMicroVector) fieldVector;
            statement.setDate(parameterIndex, new Date(timeMicroVector.getObject(0) / 1000));
        } else if (fieldVector instanceof Decimal256Vector) {
            Decimal256Vector decimal256Vector = (Decimal256Vector) fieldVector;
            statement.setBigDecimal(parameterIndex, decimal256Vector.getObject(0));
        } else if (fieldVector instanceof DecimalVector) {
            DecimalVector decimalVector = (DecimalVector) fieldVector;
            statement.setBigDecimal(parameterIndex, decimalVector.getObject(0));
        } else if (fieldVector instanceof VarBinaryVector) {
            VarBinaryVector varBinaryVector = (VarBinaryVector) fieldVector;
            statement.setBytes(parameterIndex, varBinaryVector.getObject(0));
        } else if (fieldVector instanceof VarCharVector) {
            VarCharVector varCharVector = (VarCharVector) fieldVector;
            statement.setString(parameterIndex, varCharVector.getObject(0).toString());
        } else if (fieldVector instanceof LargeVarCharVector) {
            LargeVarCharVector largeVarCharVector = (LargeVarCharVector) fieldVector;
            statement.setString(parameterIndex, largeVarCharVector.getObject(0).toString());
            ...
            statement.setBytes(parameterIndex, largeVarBinaryVector.getObject(0));
        } else if (fieldVector instanceof BitVector) {
            BitVector bitVector = (BitVector) fieldVector;
            statement.setBoolean(parameterIndex, bitVector.getObject(0));
        }
    }
